      ...
      <div className="max-w-5xl mx-auto px-4">
        ...
        <div className="flex flex-col gap-8">
          ...
          <div className="bg-white rounded-3xl overflow-hidden shadow-sm border border-gray-100">
            <div className="px-6 py-5 flex items-center gap-4" style={{ background: 'linear-gradient(135deg,#003d8f,#0077e6)' }}>
              <div className="w-12 h-12 rounded-2xl bg-white/20 flex items-center justify-center flex-shrink-0">
                <Camera size={24} className="text-white" />
              </div>
              <div>
                <span className="inline-block text-[10px] font-black uppercase tracking-widest bg-red-500 text-white px-2 py-0.5 rounded-full mb-1">АКЦИЯ</span>
            ...
            <div className="p-6">
              ...
              <div className="flex flex-wrap gap-2 mb-5">
                {['Надёжно и безопасно', 'Профессиональная установка', 'Гарантия качества'].map(a => (
                  <span key={a} className="text-xs font-medium px-3 py-1.5 rounded-full border border-blue-100 text-blue-700 bg-blue-50">{a}</span>
                ))}
              </div>
          ...
          <div className="bg-white rounded-3xl overflow-hidden shadow-sm border border-gray-100">
            <div className="px-6 py-5 flex items-center gap-4" style={{ background: 'linear-gradient(135deg,#0057B8,#0099ff)' }}>
              <div className="w-12 h-12 rounded-2xl bg-white/20 flex items-center justify-center flex-shrink-0">
            ...
            <div className="p-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-6">
                {[
                  { name: 'EZVIZ H6c Pro 2K', type: 'Кубическая 3МР', price: 5790 },
                  { name: 'EZVIZ H1c',         type: 'Кубическая 2МР', price: 5390 },
                  { name: 'EZVIZ C8W Pro 2K',  type: 'Уличная Wi-Fi камера', price: 6490 },
                  { name: 'OLAX CPE MT-30',    type: 'Сим-карта роутер 4G',  price: 2700 },
                ].map(item => (
                  <div key={item.name} className="border border-gray-100 rounded-2xl p-4 hover:border-blue-200 hover:shadow-sm transition-all">
                    ...
                    <ul className="space-y-1">
                      {['Флеш карта 64ГБ', '10 дней записи', 'Установка + расход материалы', 'Гарантия 1 год'].map(f => (
